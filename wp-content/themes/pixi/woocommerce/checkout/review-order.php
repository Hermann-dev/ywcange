...
<div class="shop_table woocommerce-checkout-review-order-table">
	<h3 class="order-review-heading"><?php esc_html_e( 'Your order', 'pixi' ); ?></h3>
	<ul>
		<li class="header">
			<span class="col-left product-name"><?php esc_html_e( 'Product', 'pixi' ); ?></span>
			<span class="col-right product-total"><?php esc_html_e( 'Total', 'pixi' ); ?></span>
		</li>
		<?php
		...
		<li class="cart-subtotal">
			<span class="col-left"><?php esc_html_e( 'Subtotal', 'pixi' ); ?></span>
		...
		<li class="order-total">
			<span class="col-left"><?php esc_html_e( 'Total', 'pixi' ); ?></span>
