...
<div class="cart_totals <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>">
	...
	<!--h2><?php esc_html_e( 'Cart Totals', 'pixi' ); ?></h2-->

	<div class="row">
		<div class="col-md-12">
			<div class="grand-total">
				<h4><?php esc_html_e( 'Cart Totals', 'pixi' ); ?></h4>
				<div class="total-wrap">
					<ul class="shop_table shop_table_responsive">

						<li class="cart-subtotal">
							<span class="title"><?php esc_html_e( 'Subtotal', 'pixi' ); ?></span>
							<span data-title="<?php esc_attr_e( 'Subtotal', 'pixi' ); ?>"><?php wc_cart_totals_subtotal_html(); ?></span>
						</li>
						...
						<?php endforeach; 
						 if ( WC()->cart->needs_shipping() && WC()->cart->show_shipping() ) : 
							...
							<li class="shipping">
								<span class="title"><?php esc_html_e( 'Shipping', 'pixi' ); ?></span>
								<span data-title="<?php esc_attr_e( 'Shipping', 'pixi' ); ?>"><?php woocommerce_shipping_calculator(); ?></span>
							</li>
						...
						if ( wc_tax_enabled() && 'excl' === WC()->cart->tax_display_cart ) :
							...
							$estimated_text  = WC()->customer->is_customer_outside_base() && ! WC()->customer->has_calculated_shipping()
									? sprintf( ' <small>(' . esc_html__( 'estimated for %s', 'pixi' ) . ')</small>', WC()->countries->estimated_for_prefix( $taxable_address[0] ) . WC()->countries->countries[ $taxable_address[0] ] )
									: '';
						...
						<li class="order-total">
							<span class="title"><?php esc_html_e( 'Total', 'pixi' ); ?></span>
							<span data-title="<?php esc_attr_e( 'Total', 'pixi' ); ?>"><?php wc_cart_totals_order_total_html(); ?></span>
						</li>
