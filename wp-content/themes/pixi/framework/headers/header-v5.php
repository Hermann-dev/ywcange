...
<?php
	...
	if($disable_stick_menu != 'on') {
		if(isset($pixi_options['stick_main_menu_v5']) && $pixi_options['stick_main_menu_v5']) {
					...
					<div class="mo-col-menu">
                     <div id="mo-header-icon" class="mo-header-icon visible-xs visible-sm"><span></span></div>
                      <div class="menu_other_v5 hidden-sm hidden-xs">
					       <?php if (isset($pixi_options['menu_other_v5']) && in_array('sidepanel', $pixi_options['menu_other_v5'])) {  ?>
						   ...
						   <?php if (isset($pixi_options['menu_other_v5']) && in_array('search', $pixi_options['menu_other_v5'])) {  ?>
						   ...
						   <?php 
							global $woocommerce;
							if (isset($pixi_options['menu_other_v5']) && in_array('cart', $pixi_options['menu_other_v5']) && class_exists('Woocommerce')) {  ?>
	                       ...
	                       <?php if (isset($pixi_options['menu_other_v5']) && in_array('social', $pixi_options['menu_other_v5'])) {  ?>
						    <ul class="social-header-v5">
								<?php top_social(); ?>
							</ul> 
					       <?php } ?>
                        
	                       <?php if (isset($pixi_options['menu_other_v5']) && in_array('lang', $pixi_options['menu_other_v5'])) {  ?>
						      <?php lang_link(); ?>
							<?php } ?>
					    
						    <?php if (isset($pixi_options['menu_other_v5']) && in_array('button', $pixi_options['menu_other_v5'])) {  
	                        if(isset($pixi_options['menu_other_but_v5']) AND $pixi_options['menu_other_but_v5'] !=''): ?>
			                     <a class="btn-nav" href="<?php echo esc_url($pixi_options['menu_other_but_link_v5']);?>"><?php echo esc_html($pixi_options['menu_other_but_v5']);?></a>
			                 <?php endif; } ?>
