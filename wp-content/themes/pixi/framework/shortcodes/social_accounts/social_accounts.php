<?php
function pixi_social_accounts_func($atts, $content = null) {
   extract(shortcode_atts(array(
	...
	<div id="<?php echo esc_attr($uniqid); ?>" class="social-icons <?php echo esc_attr(implode(' ', $class)); ?>">
		<div class="social-icon-container <?php echo esc_attr($animation_css); ?>" data-wow-delay="<?php echo esc_attr($animation_delay); ?>">
...
if(function_exists('pixi_shortcode')) { pixi_shortcode('social_accounts', 'pixi_social_accounts_func');}