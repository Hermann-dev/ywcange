<?php
function pixi_portfolio_carousel_func($atts, $content = null) {
...
if(function_exists('pixi_shortcode')) { pixi_shortcode('portfolio_carousel', 'pixi_portfolio_carousel_func'); }