<?php
function pixi_maps_render($params) {
    ...
    wp_enqueue_script('maps-api', PIXI_URI_PATH_FR . "/shortcodes/map/maps.js",array(),'1.0.0');
    /* Map Style defualt */
    $map_styles = array(
...
if(function_exists('pixi_shortcode')) { pixi_shortcode('maps', 'pixi_maps_render'); }