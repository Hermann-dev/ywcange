<?php
function pixi_portfolio_grid_func($atts, $content = null) {
	...
	$html.="</div>"; 
	$html.= pixi_pagination($wp_query, $typenavigation);
	$html.="</div><!--End .more-posts-wrapper -->"; 
    return $html;
} 
if(function_exists('pixi_shortcode')) { pixi_shortcode('portfolio_grid', 'pixi_portfolio_grid_func'); }