<?php
function pixi_textillate_func($atts, $content = null) {
	...
	wp_enqueue_script('textillate', PIXI_URI_PATH . '/assets/js/textillate.js');
	$class = array();
	$class[] = 'list';
	$class[] = $el_class;
	$lists = array();
...
if(function_exists('pixi_shortcode')) { pixi_shortcode('textillate', 'pixi_textillate_func');}