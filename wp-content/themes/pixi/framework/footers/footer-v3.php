...
<?php $footer_v3_to_top =& $pixi_options["tb_footer_v3_to_top"]; ?>
<a href="#" id="back-to-top" class="progress <?php if($footer_v3_to_top == 0){ echo "hide_icon"; }?> " data-tooltip="<?php echo esc_attr__('Back To Top', 'pixi'); ?>">
...
<footer class="footer_v3"> 
   <div class="container">
      <?php if (is_active_sidebar("pixi-footer-widget")) { ?>
        <div class="footer-widget-1 col-sm-5 col-xs-12">
