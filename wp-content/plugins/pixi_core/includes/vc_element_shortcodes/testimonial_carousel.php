	...
	"params" => array (
		array(
	     ...
	     array(
				...
				'heading'	 => '',
				'param_name' => 'style1',
			    'value'      => get_template_directory_uri().'/framework/vc_params/pixi_testimonial/pixi_testimonial_style_1.png',
	    ...
	    array(
				...
				'heading'	 => '',
				'param_name' => 'style2',
			    'value'      => get_template_directory_uri().'/framework/vc_params/pixi_testimonial/pixi_testimonial_style_2.png',
	    ...
	    array(
				...
				'heading'	 => '',
				'param_name' => 'style3',
			    'value'      => get_template_directory_uri().'/framework/vc_params/pixi_testimonial/pixi_testimonial_style_3.png',
	    ...
	    array(
				...
				'heading'	 => '',
				'param_name' => 'style4',
			    'value'      => get_template_directory_uri().'/framework/vc_params/pixi_testimonial/pixi_testimonial_style_4.png',
	   ...
	   array(
				...
				'heading'	 => '',
				'param_name' => 'style5',
			    'value'      => get_template_directory_uri().'/framework/vc_params/pixi_testimonial/pixi_testimonial_style_5.png',
				'dependency' => Array('element' => "tpl", 'value' => array('tpl5'))
		),
	    array(
			"type" => "dropdown",
			"class" => "",
			"heading" => esc_html__("text color", 'pixi'),
			"param_name" => "text_color",
			"value" => array(
				"Black" => "black_txt",
				"White"  => "white_txt",
			),
			"description" => esc_html__('the color of text in testimonial carousel.', 'pixi')
		),
		array(
			"type" => "textfield",
			"class" => "",
			...
			"param_name" => "col_lg",
			"value" => "",
			"description" => esc_html__("Please, enter number Columns Large devices Desktops (>=1200px) in this element. Default: 1", 'pixi')
		),
		array(
			"type" => "textfield",
			"class" => "",
			...
			"param_name" => "col_md",
			"value" => "",
			"description" => esc_html__("Please, enter number Columns Medium devices Desktops (>=992px) in this element. Default: 1", 'pixi')
		),
		array(
			"type" => "textfield",
			"class" => "",
			...
			"param_name" => "col_sm",
			"value" => "",
			"description" => esc_html__("Please, enter number Columns Small devices Tablets (>=768px) in this element. Default: 1", 'pixi')
		),
		array(
			"type" => "textfield",
			"class" => "",
		...
		array(
			...
			"value" => "",
			"description" => esc_html__("Please, enter number space between items in this element. Default:0", 'pixi')
		),
		array(
			"type" => "dropdown",
			"class" => "",
		...
		array (
			...
			"description" => esc_html__( "Note: By default, all your projects will be displayed. <br>If you want to narrow output, select category(s) above. Only selected categories will be displayed.", 'pixi' )
	   ),
		array (
			"type" => "textfield",
