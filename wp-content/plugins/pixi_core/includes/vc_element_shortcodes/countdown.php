<?php
vc_map(array(
	"name" => esc_html__("Countdown", 'pixi'),
	"base" => "countdown",
	...
	"params" => array(
	    ...
	    array(
			"type" => "textfield",
			"heading" => esc_html__("Date count down",'pixi'),
			"param_name" => "date_count_down",
			"value" => "",
	        "admin_label" => true,
			"description" => esc_html__("Set date count down (default:2019/10/10)",'pixi'),
		 ),
	    array(
		    "type" => "dropdown",
			"class" => "",
			"heading" => esc_html__("Position", 'pixi'),
			"param_name" => "position",
			"value" => array(
				"center" => "text-center",
				"right" => "text-right",
