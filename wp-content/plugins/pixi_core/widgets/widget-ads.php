...
class Widget_Ads extends WP_Widget {
	 function __construct() {
		parent::__construct(
			'ads-widget', // Base ID
			esc_html__( 'Pixi - Adv', 'pixi'), // Name
			array('description' => esc_html__('Display Adv on your site.', 'pixi'),) // Args
        );
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php esc_html_e('Title :', 'pixi');?></label>
		...
		<p>
		<label for="<?php echo $this->get_field_id( 'adv_img' ); ?>"><?php esc_html_e('Image URL:', 'pixi');?></label>
		<input id="<?php echo $this->get_field_id( 'adv_img' ); ?>" name="<?php echo $this->get_field_name( 'adv_img' ); ?>" value="<?php echo (isset($instance['adv_img'])?$instance['adv_img']:"");?>" class="widefat custom_media_url_ads" type="text">
			<br><br>
			<input type="button" value="<?php esc_html_e('Upload Image', 'pixi' ); ?>" class="button custom_media_upload_ads" id="custom_image_uploader_ads"/>
			<br><br>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'adv_href' ); ?>"><?php esc_html_e('Advertising url:', 'pixi');?></label>
		...
		<em style="display:block; border-top:1px solid #CCC; padding-top:10px; margin-top:25px; text-align:center;"><?php esc_html_e('OR', 'pixi');?></em>
		<p>
			<label for="<?php echo $this->get_field_id( 'adv_code' ); ?>"><?php esc_html_e('Advertising Code html ( Ex: Google ads) : ', 'pixi');?></label>
