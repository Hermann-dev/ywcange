...
class widget_flickr extends WP_Widget { 
	...
	function __construct() {
	  parent::__construct(
                'flickr', // Base ID
                esc_html__( 'Pixi - flickr Widget' , 'pixi'), // Name
                array('description' => esc_html__('Display your latest Flickr Photos', 'pixi'),) // Args
      );
	}
	// Widget Output
	...
	function form($instance) {
        ...
        <p>
			...
			<input class="widefat" id="<?php echo $this->get_field_id( 'username' ); ?>" name="<?php echo $this->get_field_name( 'username' ); ?>" value="<?php echo $instance['username']; ?>" /><br /><a href="<?php echo esc_url_raw( 'http://idgettr.com/' ); ?>" target="_blank"><?php esc_html_e('Flickr idGettr','pixi'); ?></a>
		</p>
		<p>
