<?php
class pixi_New_Tabs_Widget extends WP_Widget {
    function __construct() {
        parent::__construct(
                'mo_news_tabs_widget', // Base ID
                esc_html__( 'Pixi - Tabs Widget' , 'pixi'), // Name
                array('description' => esc_html__('News Tabs Widget', 'pixi'),) // Args
        );
    }
        ...
        <div class="tab-holder">
            <div class="tab-hold tabs-wrapper">
                <ul id="tabs" class="nav nav-tabs">
					<li class="active mo-tab" ><a href="#tab1" data-toggle="tab" ><?php echo esc_html__('Recent Post', 'pixi'); ?></a></li>
					<li class="mo-tab"><a href="#tab2" data-toggle="tab" ><?php echo esc_html__('Popular Post', 'pixi'); ?></a></li>
                </ul>
									...
									<li>
										...
										<div class="mo-details">
											<div class="mo-inner">
												...
												<ul class="mo-meta">
													<li class="mo-author"><?php echo esc_html__('By ', 'pixi').get_the_author(); ?></li>
...
function register_new_tabs_widget() {
    register_widget('pixi_New_Tabs_Widget');
}
