...
class Widget_Post extends WP_Widget {
	 function __construct() {
		parent::__construct(
			'post-widget', // Base ID
			esc_html__( 'Pixi - Post', 'pixi'), // Name
			array('description' => esc_html__('Display Post on your site.', 'pixi'),) // Args
        );
		function widget_post_scripts() {
			wp_enqueue_media();
			wp_enqueue_script('widget_post_scripts', PIXI_JS . 'widgets.js');
		}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'Post_img' ); ?>"><?php esc_html_e('Image URL :', 'pixi');?></label>
			...
			<br><br>
			<input type="button" value="<?php esc_html_e('Upload Image', 'pixi') ?>" class="button custom_media_upload_post" id="custom_image_uploader_ads"/>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php esc_html_e('Post title:', 'pixi');?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'Post_content' ); ?>"><?php esc_html_e('Post content:', 'pixi');?></label>
        ...
        <p>
			<label for="<?php echo $this->get_field_id( 'Post_href' ); ?>"><?php esc_html_e('Post url:', 'pixi');?></label>
